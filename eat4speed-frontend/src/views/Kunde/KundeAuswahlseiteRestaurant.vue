                        ...
                        <v-card>
                          ...
                          >
                            <template v-slot:item.reviewRating="{ item }">
                              <v-rating :value="item.reviewRating"></v-rating>
                            </template>
                          </v-data-table>
                          ...
                          <v-card-actions>
                            <v-textarea v-if="isUserLoggedIn" label="Kommentar" no-resize="true" clearable="true" rows="1" v-model="userComment"></v-textarea>
                          </v-card-actions>
