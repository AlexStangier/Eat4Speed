    ...
    >
      ...
      >
        <v-row no-gutters>
          ...
          >
            <v-container>
              <v-img alt="Bild von Restaurant" max-width="600" src="https://www.onpsx.de/uploads/mediapool/dvdreviews/sponge1-03.jpg"></v-img>
            </v-container>
          </v-col>
          <v-col>
            <v-container
                                  ...
                                  <v-row no-gutters>
                                    ...
                                    >
                                      <v-card
                                          ...
                                          outlined
                                      >
                                        <span class="text-left text-h6 pa-2">
                                          {{ review.rUsername}}
                                        </span>
                                      </v-card>
                                      <v-card
                                          ...
                                          outlined
                                      >
                                        <v-rating readonly :value="review.rRating" small></v-rating>
                                      </v-card>
                                    </v-col>
                                  </v-row>
                                  <v-row no-gutters>
  ...
  computed: {
    ...
    reviews(){
      ...
      return Array.from({length: this.amountReviews}, () => {
        ...
        return {
          rUsername: cReviewUsername,
          rRating: cReviewRating,
          rComment: cReviewComment
        }
      })
    },
    items(){
