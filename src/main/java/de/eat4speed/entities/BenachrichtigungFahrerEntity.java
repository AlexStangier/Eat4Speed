...
@Entity
@Table(name = "Benachrichtigung_Fahrer", schema = "eatforspeed")
public class BenachrichtigungFahrerEntity  extends PanacheEntityBase implements Serializable {
    private Long id;
    ...
    public boolean equals(Object o) {
        ...
        BenachrichtigungFahrerEntity that = (BenachrichtigungFahrerEntity) o;
